...
import org.fenixedu.sdk.models.{AttendingStudents, Evaluation, Group, Schedule, Course as CouseModel}
import org.http4s.Uri
import org.http4s.client.Client

final class Course[F[_]: Concurrent](val id: String, baseUri: Uri)(using client: Client[F]):
